/**
 * Hardcoded portfolio projects (same data for both site profiles until Directus).
 *
 * Future: swap `getProjects()` in `lib/content.js` for a Directus REST/GraphQL
 * client and keep this file as a fallback or seed.
 */
